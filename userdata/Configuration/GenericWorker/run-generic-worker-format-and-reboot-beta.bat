...
echo Position A >> C:\generic-worker\generic-worker.log
if "%USERNAME%" == "GenericWorker" ftype txtfile="C:\Windows\System32\Notepad.exe" "%%1"
echo Position B >> C:\generic-worker\generic-worker.log
...
echo Position E >> C:\generic-worker\generic-worker.log

if "%USERNAME%" != "GenericWorker" goto CheckForStateFlag
echo Position F >> C:\generic-worker\generic-worker.log
:CheckForUserProfile
echo Position G >> C:\generic-worker\generic-worker.log
echo Checking user registry hive is loaded... >> C:\generic-worker\generic-worker.log
echo Position H >> C:\generic-worker\generic-worker.log
